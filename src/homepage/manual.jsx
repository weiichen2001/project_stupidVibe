...
export default function ManualSection({ onOpenBoxClick }) {
  const handleOpenBoxClick = (e) => {
    e.preventDefault();
    if (onOpenBoxClick) {
      onOpenBoxClick();
    }
  ...
  return (
    <section className="manual-section">
      ...
      <a href="#openbox" className="manual-sticker open-box" onClick={handleOpenBoxClick}>
